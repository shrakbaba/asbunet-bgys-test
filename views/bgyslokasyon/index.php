...
/* @var $searchModel app\models\BgyslokasyonSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Lokasyonlar';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="bgyslokasyon-index">
    <h1><?= Html::encode($this->title) ?></h1>

    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

      <p>
        <?= Html::button('Lokasyon Ekle', ['value' => Url::to(['bgyslokasyon/create']),'class' => 'btn btn-success btn-lg modalButton2']) ?>
    </p>
