...
/* @var $searchModel app\models\BgyssiddettablosuSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Şiddet Tablosu';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="bgyssiddettablosu-index">

    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::button('Şiddet Tablosu Ekle', ['value' => Url::to(['bgyssiddettablosu/create']),'class' => 'btn btn-success btn-lg modalButton2']) ?>
    </p>
